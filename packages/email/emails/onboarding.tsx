        ...
        <Body className="bg-white my-auto mx-auto font-sans">
          <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] max-w-[465px]">
            ...
            <Section className="bg-[#f6f9fc] border border-solid border-[#e6ebf1] rounded p-[20px] my-[32px]">
              <Heading className="text-black text-[18px] font-semibold text-center m-0 mb-[16px]">
                What's next?
              </Heading>
              <Row>
                <Column>
                  ...
                  <Text className="text-[#666666] text-[12px] leading-[20px] m-0 mb-[12px]">
            ...
            <Text className="text-black text-[14px] leading-[24px]">
              ...
              <Link href={docsUrl} className="text-blue-600 no-underline">
                documentation
              </Link>{" "}
            ...
            <Section className="bg-[#fafbfc] border border-solid border-[#e6ebf1] rounded p-[16px] my-[32px]">
              <Text className="text-black text-[12px] leading-[20px] m-0 font-semibold">
                💡 Quick tip:
              </Text>
              <Text className="text-[#666666] text-[12px] leading-[20px] m-0 mt-[4px]">
