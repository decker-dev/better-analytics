...
description: Track events in web browsers with vanilla JavaScript, React, and other frameworks
---
...
In development, events are logged to console by default:
...
In production, events are sent to the configured endpoint:
